...
![Google Cloud project selector](/images/app/customer/mapAPI1.png)
![Project selector](/images/app/customer/mapAPI2.png)
...
![Enable Maps SDK for iOS](/images/app/customer/mapAPI3.png)
![Enable API](/images/app/customer/mapAPI4.png)
...
![Copy generated API key](/images/app/customer/mapAPI5.png)
...
3. Click **Add an item** and enter your app's **package name** (e.g. `app.snapbuy.customer`) and its **SHA-1 certificate fingerprint** (get it via `keytool -list -v -keystore your.keystore` or from Play Console → App signing).
...
3. Click **Add an item** and enter your app's **bundle identifier** (e.g. `app.snapbuy.customer`, found in Xcode → Runner target → General).
