...
The SnapBuy Web Portal is a **Next.js 16 App Router** app backed by an Admin Panel API. It is a **white-label template**: colours, header artwork, home page composition, channels, and languages all arrive from the API at runtime.
